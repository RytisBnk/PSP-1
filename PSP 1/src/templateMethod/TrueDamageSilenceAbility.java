...
public class TrueDamageSilenceAbility extends TrueDamageAbility {
    public TrueDamageSilenceAbility(Unit caster, Unit target, double baseDamage, List<Scaling> abilityScaling) {
