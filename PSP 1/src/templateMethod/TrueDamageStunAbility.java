...
public class TrueDamageStunAbility extends TrueDamageAbility {
    public TrueDamageStunAbility(Unit caster, Unit target, double baseDamage, List<Scaling> abilityScaling) {
