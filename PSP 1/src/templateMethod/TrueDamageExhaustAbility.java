...
public class TrueDamageExhaustAbility extends TrueDamageAbility {
    public TrueDamageExhaustAbility(Unit caster, Unit target, double baseDamage, List<Scaling> abilityScaling) {
