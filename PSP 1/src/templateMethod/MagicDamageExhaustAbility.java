...
public class MagicDamageExhaustAbility extends MagicDamageAbility {
    public MagicDamageExhaustAbility(Unit caster, Unit target, double baseDamage, List<Scaling> abilityScaling) {
