...
public class MagicDamageStunAbility extends MagicDamageAbility {
    public MagicDamageStunAbility(Unit caster, Unit target, double baseDamage, List<Scaling> abilityScaling) {
