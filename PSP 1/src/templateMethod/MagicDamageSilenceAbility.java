...
public class MagicDamageSilenceAbility extends MagicDamageAbility {
    public MagicDamageSilenceAbility(Unit caster, Unit target, double baseDamage, List<Scaling> abilityScaling) {
